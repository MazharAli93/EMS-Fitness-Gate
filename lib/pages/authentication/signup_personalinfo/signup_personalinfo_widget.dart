...
import 'signup_personalinfo_model.dart';
export 'signup_personalinfo_model.dart';

class SignupPersonalinfoWidget extends StatefulWidget {
  /// Continuation for signup page
  const SignupPersonalinfoWidget({super.key});

  @override
  State<SignupPersonalinfoWidget> createState() =>
      _SignupPersonalinfoWidgetState();
}

class _SignupPersonalinfoWidgetState extends State<SignupPersonalinfoWidget> {
  late SignupPersonalinfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupPersonalinfoModel());
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          fillColor: FlutterFlowTheme.of(context).main,
                          elevation: 2.0,
                          borderColor:
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller:
                              _model.socialStatusDropDownValueController ??=
                                  FormFieldController<String>(null),
                          options: const ['Single', 'Married', 'Divorced', 'Widowed'],
                          onChanged: (val) => safeSetState(
                              () => _model.socialStatusDropDownValue = val),
                          width: MediaQuery.sizeOf(context).width * 0.9,
                          height: 55.0,
                          textStyle:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.bloodTypeDropDownValue == null) {
                              return;
                            }
                            if (_model.socialStatusDropDownValue == null) {
                              return;
                            }
                            FFAppState().DateofBirth = _model.datePicked;
                            FFAppState().Gender = _model.genderDropDownValue!;
                            FFAppState().MaritialStatus =
                                _model.socialStatusDropDownValue!;
                            FFAppState().Bloodtype =
                                _model.bloodTypeDropDownValue!;
                            FFAppState().Address =
                                _model.addressTextController.text;
                            FFAppState().EmergencyName =
                                _model.emergencyNameTextController.text;
                            FFAppState().EmergencyNumber =
                                _model.emergencyPhoneTextController.text;
                            FFAppState().Height =

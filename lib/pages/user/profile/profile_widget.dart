...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    _model.emergencyNameTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.emergencyContactName, ''));
    _model.emergencyNameFocusNode ??= FocusNode();

    _model.emergencyPhoneTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.emergencyContactPhone, ''));
                        ...
                        builder: (context) => FlutterFlowDropDown<String>(
                          controller:
                              _model.bloodTypeDropDownValueController ??=
                                  FormFieldController<String>(
                            _model.bloodTypeDropDownValue ??= valueOrDefault(
                        ...
                        builder: (context) => FlutterFlowDropDown<String>(
                          controller:
                              _model.socialStatusDropDownValueController ??=
                                  FormFieldController<String>(
                            _model.socialStatusDropDownValue ??= valueOrDefault(
                                currentUserDocument?.maritialStatus, ''),
                          ),

  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case AppMessagesRow:
            return AppMessagesRow(data);
          case InbodyRow:
            return InbodyRow(data);
          case BodyCompositionRow:
            return BodyCompositionRow(data);
          case FatMassAnalysisRow:
            return FatMassAnalysisRow(data);
          case PackagesRow:
          ...
          case HealthInformationRow:
            return HealthInformationRow(data);
          default:
            return null;
        }

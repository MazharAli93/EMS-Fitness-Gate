...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/signupPersonalinfo',
          builder: (context, params) => const SignupPersonalinfoWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'Inbody',
          path: '/inbody',
          builder: (context, params) => const InbodyWidget(),
        ),
        FFRoute(
          name: 'AboutUs',
          path: '/aboutUs',
        ...
        FFRoute(
          name: 'HealthInfo',
          path: '/healthInfo',
          builder: (context, params) => const HealthInfoWidget(),
        ),
        FFRoute(
          name: 'NutritianPlan',
          path: '/nutritianPlan',
          builder: (context, params) => const NutritianPlanWidget(),
        ),
        FFRoute(
          name: 'TrainerInfo',
          path: '/trainerInfo',
          builder: (context, params) => const TrainerInfoWidget(),
        ),
        FFRoute(
          name: 'Plans',
          path: '/plans',

...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color main = const Color(0xFF39425A);
  late Color textColor = const Color(0xFFFFCB05);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color main = const Color(0xFF52103B);
  late Color textColor = const Color(0xFFFA05B3);
}
